function initMap() {
  ...
  // Start playing the jeopardy music
  ...
  */
  ...
  async function startNewRound() {
    ...
    // Start the jeopardy music from the beginning
    const jeopardyMusic = document.getElementById('jeopardyMusic');
    jeopardyMusic.pause(); // Ensure it's stopped
    jeopardyMusic.currentTime = 0; // Reset to beginning
    jeopardyMusic.play(); // Start playing
  }
...
document.addEventListener("DOMContentLoaded", function() {
    // Play the jeopardy music when the page loads
    const jeopardyMusic = document.getElementById('jeopardyMusic');
    jeopardyMusic.play();
